...
while True:
    ...
    if "time" in Command:
        ...
        Answer=["Hey, I am ARIA, an artificial intelligence.","I am an artificial intelligence, people called me Artificial responsive intelligent assistant"," I am a computer program and my name is ARIA"]
